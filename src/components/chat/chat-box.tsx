                ...
                <div className="px-4 py-2 grid grid-cols-2 gap-2">
                    {[
                        ...
                        <button
                            ...
                            className="px-3 py-2 bg-gray-50 hover:bg-emerald-50 text-xs font-medium text-gray-700 rounded-lg border border-gray-100 hover:border-emerald-200 hover:text-emerald-700 transition-all duration-200 ease-out touch-manipulation active:bg-emerald-100 text-left truncate"
                            title={text}
                        >
                            {text}
                        </button>
