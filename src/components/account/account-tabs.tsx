...
import { User, MapPin, Lock, Shield, Trash2, Briefcase, ArrowLeft, Menu, X } from "lucide-react"
  ...
  const SidebarContent = ({ onTabClick }: { onTabClick?: () => void }) => (
    <>
      ...
      <div className="flex-1 flex flex-col justify-between p-3">
        ...
        {/* Status Messages - pushed to bottom */}
        <div className="mt-4">
    ...
    <>
      ...
      <div className="flex-1 lg:overflow-y-auto">
        <div className="h-full p-4 sm:p-6 lg:p-8">
          <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 lg:p-8 h-full lg:h-auto">
