    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-sm border-b border-border">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 h-14 flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 font-bold text-lg transition-colors duration-200 ease-out touch-manipulation">
          ...
          <nav className="flex items-center gap-2 sm:gap-3">
            ...
            {isArtisan && (
              <Link
                href="/pro/urgences"
                className="relative flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-sm font-medium text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 transition-colors duration-200 ease-out touch-manipulation"
              >
            ...
            {isAdmin && (
              <Link
                href="/admin/artisans"
                className="flex items-center gap-1.5 text-sm font-medium text-purple-600 hover:text-purple-700 transition-colors duration-200 ease-out touch-manipulation"
              >
            ...
            {user ? (
              ...
              <>
                ...
                <Link
                  href="/login"
                  className="flex items-center justify-center text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200 ease-out p-2 sm:p-0 rounded-lg hover:bg-gray-100 sm:hover:bg-transparent touch-manipulation"
                >
                ...
                <Link
                  href="/signup"
                  className="sm:hidden flex items-center justify-center w-9 h-9 rounded-full bg-slate-900 text-white hover:bg-slate-800 transition-colors duration-200 ease-out touch-manipulation"
                >
