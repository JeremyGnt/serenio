...
interface StepRecapProps {
    ...
    onUpdate: (data: Partial<StepRecapFormState>) => void
}

export function StepRecap({ formState, selectedScenario, onUpdate }: StepRecapProps) {
        ...
        <div className="space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-center space-y-2">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                    Vérifiez les informations ci-dessous avant de confirmer l'intervention d'urgence.
                </p>
            </div>
                        ...
                        <div className="p-6 space-y-6 flex-1">
                            ...
                            <div className="flex items-start justify-between group/item">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-500 uppercase tracking-wider text-[10px]">Problème</p>
                                        <p className="font-semibold text-gray-900">{situation?.label || "Non spécifié"}</p>
                                        <p className="text-sm text-gray-500 mt-0.5">{situation?.description}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start justify-between group/item">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-500 uppercase tracking-wider text-[10px]">Intervention</p>
                                        <p className="font-semibold text-gray-900">Urgence immédiate 24/7</p>
                                        <div className="flex items-center gap-1.5 text-sm text-gray-500 mt-0.5">
                                            <Timer className="w-3.5 h-3.5" />
                                            Arrivée estimée en 30 min
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        {formState.addressInstructions && (
                                            <p className="text-xs text-gray-400 mt-1 italic">"{formState.addressInstructions}"</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1 h-8 flex items-center">
                                                {isEditingContact ? (
                                                    ...
                                                    <p className="text-sm text-gray-700 font-medium">{formState.clientPhone}</p>
                                                )}
                                            </div>
                                        </div>
