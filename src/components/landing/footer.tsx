      ...
      <div className="max-w-5xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 mb-4 active:scale-[0.98] transition-all duration-200 ease-out active:duration-75 touch-manipulation">
              <Image
                src="/logo.svg"
                alt="Serenio"
                width={32}
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:contact@serenio.fr" className="flex items-center gap-2 text-sm hover:text-white active:text-white active:scale-[0.98] touch-manipulation transition-all duration-200 ease-out active:duration-75">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/urgence" className="hover:text-white active:text-white active:scale-[0.98] touch-manipulation transition-all duration-200 ease-out active:duration-75 inline-block">
                  Urgence serrurier
                </Link>
              </li>
              <li>
                <Link href="/rdv" className="hover:text-white active:text-white active:scale-[0.98] touch-manipulation transition-all duration-200 ease-out active:duration-75 inline-block">
                  Prendre rendez-vous
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/pro/register" className="hover:text-white active:text-white active:scale-[0.98] touch-manipulation transition-all duration-200 ease-out active:duration-75 inline-block">
