        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:contact@serenio.fr" className="flex items-center gap-2 text-sm hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/urgence" className="hover:text-white transition-colors">
                  Urgence serrurier
                </Link>
              </li>
              <li>
                <Link href="/rdv" className="hover:text-white transition-colors">
                  Prendre rendez-vous
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/pro/register" className="hover:text-white transition-colors">
