...
function mapDiagnosticFromDb(data: Record<string, unknown>) {
  ...
  return {
    ...
    situationType: data.situation_type as string,
    situationDetails: data.situation_details as string | undefined,
    diagnosticAnswers: data.diagnostic_answers as Record<string, unknown>,
    doorType: data.door_type as string | undefined,
    lockType: data.lock_type as string | undefined,
    ...
    estimatedComplexity: data.estimated_complexity as number,
    createdAt: data.created_at as string,
    updatedAt: data.updated_at as string,
  }
}
...
function mapPhotoFromDb(data: Record<string, unknown>) {
  return {
    ...
    photoType: data.photo_type as string,
    description: data.description as string | undefined,
    uploadedBy: data.uploaded_by as string | undefined,
    uploadedByRole: data.uploaded_by_role as string | undefined,
    createdAt: data.created_at as string,
  }
}
