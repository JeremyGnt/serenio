...
export const STATUS_LABELS: Record<string, { label: string; color: string; description: string }> = {
  ...
  pending: { label: "Demande reçue", color: "amber", description: "Votre demande a bien été enregistrée" },
  searching: { label: "Demande reçue", color: "amber", description: "Votre demande a bien été enregistrée" },
  assigned: { label: "Assigné", color: "emerald", description: "Un serrurier a été trouvé" },
  accepted: { label: "Accepté", color: "emerald", description: "Le serrurier a utilisé la plateforme" },
  en_route: { label: "En route", color: "blue", description: "Le serrurier est en chemin" },
  arrived: { label: "Arrivé", color: "purple", description: "Le serrurier est sur place" },
  diagnosing: { label: "Diagnostic", color: "emerald", description: "Diagnostic en cours" },
  quote_sent: { label: "Devis envoyé", color: "emerald", description: "En attente de votre validation" },
  quote_accepted: { label: "Devis accepté", color: "emerald", description: "Intervention confirmée" },
  quote_refused: { label: "Devis refusé", color: "red", description: "Vous avez refusé le devis" },
  in_progress: { label: "En cours", color: "blue", description: "Intervention en cours" },
  completed: { label: "Terminé", color: "emerald", description: "Intervention terminée" },
