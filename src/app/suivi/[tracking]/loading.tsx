...
export default function TrackingLoading() {
    return (
        <div className="min-h-screen bg-secondary/30 pb-20 animate-in fade-in duration-300">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 space-y-6">
                {/* Back Button Skeleton */}
                <div className="w-20 h-8 bg-gray-100 rounded-lg animate-pulse mb-6" />
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    {/* Timeline Skeleton - Waiting state */}
                    <div className="bg-white rounded-2xl border border-gray-200 p-5">
